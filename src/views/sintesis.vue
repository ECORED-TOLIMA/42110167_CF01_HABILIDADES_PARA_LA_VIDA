...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5(data-aos="fade-right") A modo de conclusión, se presenta un esquema diseñado para sintetizar de forma clara y gráfica el conocimiento expuesto en esta temática. Este mapa conceptual busca facilitar la comprensión de las relaciones y jerarquías presentes en la teoría desarrollada.
